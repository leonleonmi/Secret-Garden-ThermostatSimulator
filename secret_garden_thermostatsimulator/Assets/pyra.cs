...
public class pyra : MonoBehaviour
{
  // Start is called before the first frame update
    ...
    {
		float hoehe = Random.Range(1.0f, 10.0f);   //Der Y-Wert des Daches variiert von 3-9, damit die Haeuser unterschiedliche Hoehen haben
		Vector3 a = new Vector3(8, 0, 8) + position;
		Vector3 b = new Vector3(-8, 0, 8) + position;
		Vector3 c = new Vector3(-8, 0, -8) + position;
		Vector3 d = new Vector3(8, 0, -8) + position;
    ...
    {
		float hoehe = Random.Range(1.0f, 2.0f);   //Der Y-Wert des Daches variiert von 3-9, damit die Haeuser unterschiedliche Hoehen haben
		Vector3 a = new Vector3(2, 0, 2) + position;
		Vector3 b = new Vector3(-2, 0, 2) + position;
		Vector3 c = new Vector3(-2, 0, -2) + position;
		Vector3 d = new Vector3(2, 0, -2) + position;
	...
	void createTown()
    {
		...
		for(int i = -5; i < 5; i = i + 2)
        {
            ...
            {
				Vector3 position = new Vector3((i *Random.Range(-9,8)), 0,(j*Random.Range(-8,8)));
